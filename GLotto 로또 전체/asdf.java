...
public class ManegeMember {
   ...
   public ManegeMember() {
      ...
      //Á¦¸ñ Label
      JLabel lblNewLabel = new JLabel("ÀüÃ¼È¸¿øÁ¤º¸");
      lblNewLabel.setFont(new Font("ÈÞ¸Õ¿¢½ºÆ÷", Font.BOLD, 16));
      namepnl.add(lblNewLabel);
      
      //¸Þ´º ¶óº§
      JLabel lblNewLabel_2 = new JLabel("¼ø¹ø");
      lblNewLabel_2.setFont(new Font("ÈÞ¸Õ¿¢½ºÆ÷", Font.BOLD, 12));
      lblNewLabel_2.setBounds(0, 10, 42, 15);
      menupnl.add(lblNewLabel_2);
      
      JLabel lblNewLabel_3 = new JLabel("ÀÌ¸§");
      lblNewLabel_3.setFont(new Font("ÈÞ¸Õ¿¢½ºÆ÷", Font.BOLD, 12));
      lblNewLabel_3.setBounds(80, 10, 57, 15);
      menupnl.add(lblNewLabel_3);
      
      JLabel lblNewLabel_4 = new JLabel("¾ÆÀÌµð");
      ...
      //1¹ø ¸â¹ö    
      JLabel name1 = new JLabel("name10ÀÇ ÀÌ¸§");
      name1.setFont(new Font("ÈÞ¸Õ¸ðÀ½T", Font.PLAIN, 12));
      name1.setBounds(0, 10, 82, 29);
      pnlm1.add(name1);
      namelist.add(name1);
      
      JLabel id1 = new JLabel("New label");
      id1.setFont(new Font("ÈÞ¸Õ¸ðÀ½T", Font.PLAIN, 12));
      id1.setBounds(110, 10, 81, 29);
      pnlm1.add(id1);
      idlist.add(id1);
      
      JLabel ftel1 = new JLabel("New label");
      ftel1.setFont(new Font("ÈÞ¸Õ¸ðÀ½T", Font.PLAIN, 12));
      ftel1.setBounds(203, 13, 34, 22);
      pnlm1.add(ftel1);
      ftellist.add(ftel1);
      
      JLabel mtel1 = new JLabel("New label");
      mtel1.setFont(new Font("ÈÞ¸Õ¸ðÀ½T", Font.PLAIN, 12));
      mtel1.setBounds(251, 13, 34, 22);
      pnlm1.add(mtel1);
      mtellist.add(mtel1);
      
      JLabel ltel1 = new JLabel("New label");
      ltel1.setFont(new Font("ÈÞ¸Õ¸ðÀ½T", Font.PLAIN, 12));
      ...
      name3.setFont(new Font("ÈÞ¸Õ¸ðÀ½T", Font.PLAIN, 12));
      name3.setBounds(0, 10, 82, 29);
      pnlm3.add(name3);
      
      JLabel id3 = new JLabel("New label");
      id3.setFont(new Font("ÈÞ¸Õ¸ðÀ½T", Font.PLAIN, 12));
      ...
      ftel3.setFont(new Font("ÈÞ¸Õ¸ðÀ½T", Font.PLAIN, 12));
      ...
      name4.setFont(new Font("ÈÞ¸Õ¸ðÀ½T", Font.PLAIN, 12));
      name4.setBounds(0, 10, 82, 29);
      pnlm4.add(name4);
      namelist.add(name4);
      
      JLabel id4 = new JLabel("New label");
      id4.setFont(new Font("ÈÞ¸Õ¸ðÀ½T", Font.PLAIN, 12));
      id4.setBounds(110, 10, 126, 29);
      pnlm4.add(id4);
      idlist.add(id4);
      
      JLabel ftel4 = new JLabel("New label");
      ftel4.setFont(new Font("ÈÞ¸Õ¸ðÀ½T", Font.PLAIN, 12));
      ...
      name5.setFont(new Font("ÈÞ¸Õ¸ðÀ½T", Font.PLAIN, 12));
      name5.setBounds(0, 10, 82, 29);
      pnlm5.add(name5);
      namelist.add(name5);
      
      JLabel id5 = new JLabel("New label");
      id5.setFont(new Font("ÈÞ¸Õ¸ðÀ½T", Font.PLAIN, 12));
      id5.setBounds(110, 10, 126, 29);
      pnlm5.add(id5);
      idlist.add(id5);
      
      JLabel ftel5 = new JLabel("New label");
      ftel5.setFont(new Font("ÈÞ¸Õ¸ðÀ½T", Font.PLAIN, 12));
      ...
      name6.setFont(new Font("ÈÞ¸Õ¸ðÀ½T", Font.PLAIN, 12));
      name6.setBounds(0, 10, 82, 29);
      pnlm6.add(name6);
      namelist.add(name6);
      
      JLabel id6 = new JLabel("New label");
      id6.setFont(new Font("ÈÞ¸Õ¸ðÀ½T", Font.PLAIN, 12));
      id6.setBounds(110, 10, 126, 29);
      pnlm6.add(id6);
      idlist.add(id6);
      
      JLabel ftel6 = new JLabel("New label");
      ftel6.setFont(new Font("ÈÞ¸Õ¸ðÀ½T", Font.PLAIN, 12));
      ...
      name7.setFont(new Font("ÈÞ¸Õ¸ðÀ½T", Font.PLAIN, 12));
      name7.setBounds(0, 10, 82, 29);
      pnlm7.add(name7);
      namelist.add(name7);
      
      JLabel id7 = new JLabel("New label");
      id7.setFont(new Font("ÈÞ¸Õ¸ðÀ½T", Font.PLAIN, 12));
      id7.setBounds(110, 10, 126, 29);
      pnlm7.add(id7);
      idlist.add(id7);
      
      JLabel ftel7 = new JLabel("New label");
      ftel7.setFont(new Font("ÈÞ¸Õ¸ðÀ½T", Font.PLAIN, 12));
      ...
      name8.setFont(new Font("ÈÞ¸Õ¸ðÀ½T", Font.PLAIN, 12));
      name8.setBounds(0, 10, 82, 29);
      pnlm8.add(name8);
      namelist.add(name8);
      
      JLabel id8 = new JLabel("New label");
      id8.setFont(new Font("ÈÞ¸Õ¸ðÀ½T", Font.PLAIN, 12));
      id8.setBounds(110, 10, 126, 29);
      pnlm8.add(id8);
      idlist.add(id8);
      
      JLabel ftel8 = new JLabel("New label");
      ftel8.setFont(new Font("ÈÞ¸Õ¸ðÀ½T", Font.PLAIN, 12));
      ...
      name9.setFont(new Font("ÈÞ¸Õ¸ðÀ½T", Font.PLAIN, 12));
      name9.setBounds(0, 10, 82, 29);
      pnlm9.add(name9);
      namelist.add(name9);
      
      JLabel id9 = new JLabel("New label");
      id9.setFont(new Font("ÈÞ¸Õ¸ðÀ½T", Font.PLAIN, 12));
      id9.setBounds(110, 10, 126, 29);
      pnlm9.add(id9);
      idlist.add(id9);
      
      JLabel ftel9 = new JLabel("New label");
      ftel9.setFont(new Font("ÈÞ¸Õ¸ðÀ½T", Font.PLAIN, 12));
      ...
      //10¹ø¸â¹ö
      JLabel name10 = new JLabel("10¹øÀÌ¸§¶óº§");
      name10.setFont(new Font("ÈÞ¸Õ¸ðÀ½T", Font.PLAIN, 12));
      name10.setBounds(0, 10, 82, 29);
      pnlm10.add(name10);
      namelist.add(name10);
      
      JLabel id10 = new JLabel("New label");
      id10.setFont(new Font("ÈÞ¸Õ¸ðÀ½T", Font.PLAIN, 12));
      id10.setBounds(110, 10, 126, 29);
      pnlm10.add(id10);
      idlist.add(id10);
      
      JLabel ftel10 = new JLabel("New label");
      ftel10.setFont(new Font("ÈÞ¸Õ¸ðÀ½T", Font.PLAIN, 12));
      ...
      //ÃÊ±âÈ­¸é ¹öÆ° 
      JButton manageulbtn = new JButton("ÃÊ±âÈ­¸é");
